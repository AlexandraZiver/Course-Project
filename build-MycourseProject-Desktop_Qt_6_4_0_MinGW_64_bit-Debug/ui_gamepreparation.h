...
"background-image:url(:/images/arrow-l.png);background-repeat: no-repeat;"));
        lineEdit_3 = new QLineEdit(gamepreparation);
        lineEdit_3->setObjectName("lineEdit_3");
        lineEdit_3->setGeometry(QRect(380, 360, 101, 24));
        lineEdit_3->setStyleSheet(QString::fromUtf8("border: 2px solid rgb(233, 160, 157); \n"
"\n"
...
"padding-left: 30px;\n"
"border-radius:10%;"));
        pushButton = new QPushButton(gamepreparation);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(340, 460, 41, 61));
        pushButton->setStyleSheet(QString::fromUtf8("border: 0;\n"
"background-image:url(:/images/arrow-l.png);\n"
"background-repeat: no-repeat;"));
        pushButton_2 = new QPushButton(gamepreparation);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(510, 460, 41, 51));
...
"background-repeat: no-repeat;"));
    ...
    void retranslateUi(QDialog *gamepreparation)
    {
        ...
        Gamer1->setText(QCoreApplication::translate("gamepreparation", "\320\223\321\200\320\260\320\262\320\265\321\206\321\214 2", nullptr));
        Gamer2->setText(QCoreApplication::translate("gamepreparation", "\320\223\321\200\320\260\320\262\320\265\321\206\321\214 1", nullptr));
