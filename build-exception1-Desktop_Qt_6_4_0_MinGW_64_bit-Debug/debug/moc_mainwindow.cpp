...
#include <memory>
#include "../../exception1/mainwindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Main_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Main_t qt_meta_stringdata_Main = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Main[] = {
...
Q_CONSTINIT const QMetaObject Main::staticMetaObject = { {
    QMetaObject::SuperData::link<QMain::staticMetaObject>(),
    qt_meta_stringdata_Main.offsetsAndSizes,
    qt_meta_data_Main,
    qt_static_metacall,
    nullptr,
...
void *Main::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Main.stringdata0))
        return static_cast<void*>(this);
    return QMain::qt_metacast(_clname);
}

int Main::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QMain::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
